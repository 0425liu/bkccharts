...
(function (f) {
    ...
    p(s.lang, {
        ...
        downloadJPEG: "导出为JPG图片",
        downloadPDF: "导出为PDF格式",
        downloadSVG: "导出为SVG格式",
        contextButtonTitle: "打印导入图表"
    });
    s.navigation = {
        menuStyle: {
    ...
    p(A.prototype, {
        getSVG: function (b) {
            ...
            c = g.exporting.sourceWidth || g.chart.width || /px$/.test(c) && parseInt(c, 10) || 900;
            h = g.exporting.sourceHeight || g.chart.height || /px$/.test(h) && parseInt(h, 10) || 300;
            p(g.chart, {
                animation: !1,
                renderTo: b,
                forExport: !0,
        ...
        destroyExport: function (b) {
            ...
            for (a = 0; a < b.exportDivElements.length; a++) d = b.exportDivElements[a],
            B(d, "mouseleave"),
